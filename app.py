...
if __name__ == '__main__':
    ...
    print("💊 Health Check: http://localhost:5000/api/heart_disease_prediction")
    print()
    print("📋 How to use your PKL model:")
    print("1. The system will try to load 'models/ensemble_model.pkl' or 'ensemble_model.pkl' in the project root")
    print("2. Or save your trained model as 'model.pkl' or provide a path when creating the predictor")
